...
from smaile import xml_parser
from smaile.Provider import Provider, Service
from smaile.utils import is_online, get_email_domain_name, parse_mailbox, update_provider
...
class MailExtractor:
    ...
    def __init__(self, target_email, target_password, as_json=False, output_file_path="out.json",
        ...
        assert len(self.provider_list), "no providers found | try to --update"
